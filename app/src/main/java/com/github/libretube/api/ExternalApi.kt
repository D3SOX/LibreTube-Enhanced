...
private const val GITHUB_RELEASES_API_URL = "https://api.github.com/repos/OpenTubeX/LibreTube-Enhanced/releases?per_page=1"
...
interface ExternalApi {
    ...
    suspend fun getReleases(): List<UpdateInfo>
